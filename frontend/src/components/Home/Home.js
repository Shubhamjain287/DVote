    ...
    <>
      ...
      >
        ...
        <div id="transparency-text">
          ...
          <h3>Built-in.</h3>
          <p>
            D-Vote is the online voting platform.
            <br />
            This guarantees that anyone can verify its Voting through
            BlockChain.
          </p>
        </div>
        ...
        <div id="integrity-text">
          <br />
          <h2>Integrity.</h2>
          <h3>Built-in.</h3>
          <p>
            You don’t even have to trust the administrators or the Voting
            trustees...
            <br />
            D-Vote unique design safeguards the integrity of the elections on
            all levels.
          </p>
        </div>
      ...
      <section id="go-online">
        <div id="go-online-text">
          ...
          <div id="easy-fast">
            <h2>Easy & Fast</h2>
            <p>
              So much easier, both for the organization and the voters. Faster
              voting, faster results.
            </p>
          </div>
          <div id="increase-participation">
            <h2>Increase Participation</h2>
            <p>
              Include the remote and the disabled, as everyone can vote from
              anywhere.
            </p>
          </div>
          <div id="reduce-cost">
            <h2>Reduce Costs</h2>
            <p>
              Drastically lower production and administration costs for the
              organization. Zero cost for the voters.
            </p>
          </div>
        </div>
